...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/v1/adhoc-declarations/declare").hasAnyRole(Role.ADMIN.name(), Role.SUPER_ADMIN.name(), Role.MANAGER.name(), Role.USER.name())
                .requestMatchers(GET, "/api/v1/adhoc-declarations/declare/**").hasAnyAuthority(Role.SUPER_ADMIN.name(), Role.ADMIN.name(), Role.MANAGER.name(), Role.USER.name())
                .requestMatchers(POST, "/api/v1/adhoc-declarations/declare/**").hasAnyAuthority(Role.SUPER_ADMIN.name(), Role.ADMIN.name(), Role.MANAGER.name(), Role.USER.name())
                .requestMatchers(PUT, "/api/v1/adhoc-declarations/declare/**").hasAnyAuthority(Role.SUPER_ADMIN.name(), Role.ADMIN.name(), Role.MANAGER.name())
                .requestMatchers(DELETE, "/api/v1/adhoc-declarations/declare/**").hasAnyAuthority(Role.SUPER_ADMIN.name(), Role.ADMIN.name(), Role.MANAGER.name())
                .requestMatchers(PATCH, "/api/v1/adhoc-declarations/declare/**").hasAnyAuthority(Role.SUPER_ADMIN.name(), Role.ADMIN.name(), Role.MANAGER.name(), Role.USER.name())


                .requestMatchers("/api/v1/adhoc-declarations/").hasAnyRole(Role.ADMIN.name(), Role.SUPER_ADMIN.name(), Role.MANAGER.name(), Role.USER.name())
                .requestMatchers(GET, "/api/v1/adhoc-declarations/**").hasAnyAuthority(Role.SUPER_ADMIN.name(), Role.ADMIN.name(), Role.MANAGER.name(), Role.USER.name())
