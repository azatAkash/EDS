...
public class NotificationService {
        ...
        public String[] newDeclarationMessageText(String recipientEmail,
                ...
                String bodyRu = String.format(
                                "Здравствуйте, %s!\n\n" +
                                                "Отдел комплаенса Назарбаев Университета назначил вам новую Декларацию по разрешению конфликта. "
                                                +
                                                "Пожалуйста, перейдите по этой ссылке для её заполнения: %s\n\n" +
                                                "Если у вас возникнут вопросы, обратитесь в Отдел комплаенса.\n\n" +
                                                "С уважением,\n" +
                                                "Отдел комплаенса Назарбаев Университета",
                                fullName, link);

                // Казахский текст
                String bodyKk = String.format(
                                "Құрметті %s,\n\n" +
                                                "Назарбаев Университетінің Комплаенс Офисы сізге жаңа мүдделер қақтығыстарын шешу декларациясын ұсынды. "
                                                +
                                                "Декларацияны мына сілтеме арқылы өтіп толтырыңыз: %s\n\n" +
                                                "Кез келген сұрақ туындаса, Комплаенс Офисына хабарласыңыз.\n\n" +
                                                "Құрметпен,\n" +
                                                "Назарбаев Университеті, Комплаенс Офисы",
                                fullName, link);
